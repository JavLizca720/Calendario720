<div class="modal" id="modalUpdateEvento"  tabindex="-1" role="dialog">
  ...
  <form name="formEventoUpdate" id="formEventoUpdate" action="update_evento.php" class="form-horizontal" method="POST">
    ...
    <div class="form-group">
      <label for="fecha_fin" class="col-sm-12 control-label">Fecha del final</label>
      <div class="col-sm-10">
    ...
    <div class="col-md-12 activado">
     ...
     <div class="modal-footer">
        <button type="submit" class="btn btn-success">Guardar Cambios del evento</button>
